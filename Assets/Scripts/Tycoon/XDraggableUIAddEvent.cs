namespace Assets.Scripts.Tycoon
{
    ...
    public class XDraggableUIAddEvent : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
    {
        [SerializeField]
        ...
        public void OnPointerUp(PointerEventData eventData)
        {
            ...
            bool position=distanceToClosePositionX < distanceToOpenPositionX;
            ...
            StartCoroutine(SmoothMove(targetPosition, targetTime, position));
        }

        private IEnumerator SmoothMove(Vector2 targetPosition, float duration, bool position)
        {
            ...
            OnOpenPosition.Invoke(position);
            Debug.Log("@@@@@@@@@@@@@      "+position);
        }
        ...
        public UnityEvent<bool> OnOpenPosition;
    }
}